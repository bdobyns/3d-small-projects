...
diameter=90;
height=14;
        text_on_cube(cube_size=[diameter,height,diameter], t=label,
            face=bottom,direction=rtl);
*/
talenti_lid();
translate([-31,-31,1])  import("E-mount_rear_lenscap.STL");

// first the talenti icecream lid
// nominal measured height=13, diameter=90, threadpitch=4.9, wallthickness=1.8
module talenti_lid(height=14, diameter=90, threadpitch=4.9, wallthickness=3) {
    ...
    difference(){
        union() {
            ...
            inside_threaded_ring(pos=0,ht=14,dia=96,thread=90, pitch=4.9, rot=0);
